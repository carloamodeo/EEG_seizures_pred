import numpy as np
import pickle
from get_prepare_data_full import * # Full features

def read_data_create_features(experiment_name, reshuffle = False):
	# Path
	path_name = r"D:\projects\EEG_American\time-series-medicine-master\time-series-medicine-master\EEG\Data\Dog_2\"
	newPath = path_name.replace(os.sep, '/')
...
def main():
	read_data_create_features("ciao", reshuffle = False)
